...
module cameramanager_testbench();
	...
	cameramanager dut (.startsys, .downloadresponce1, .downloadresponce2, .clk, .reset, .cam1stn, .cam2stn, .ReToDload1, .ReToDload2, .datacam1n, .datacam2n);
